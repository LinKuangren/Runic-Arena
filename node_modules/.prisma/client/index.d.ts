...
export namespace Prisma {
  ...
  */
  ...
  export type CarteCountOutputType = {
    capacite_actives: number
  }

  export type CarteCountOutputTypeSelect = {
    capacite_actives?: boolean
  }
  ...
  /**
   * Count Type CapaciteCountOutputType
   */


  export type CapaciteCountOutputType = {
    carte_passive: number
    carte_actives: number
  }

  export type CapaciteCountOutputTypeSelect = {
    carte_passive?: boolean
    carte_actives?: boolean
  }

  export type CapaciteCountOutputTypeGetPayload<S extends boolean | null | undefined | CapaciteCountOutputTypeArgs> =
    S extends { select: any, include: any } ? 'Please either choose `select` or `include`' :
    S extends true ? CapaciteCountOutputType :
    S extends undefined ? never :
    S extends { include: any } & (CapaciteCountOutputTypeArgs)
    ? CapaciteCountOutputType 
    : S extends { select: any } & (CapaciteCountOutputTypeArgs)
      ? {
    [P in TruthyKeys<S['select']>]:
    P extends keyof CapaciteCountOutputType ? CapaciteCountOutputType[P] : never
  } 
      : CapaciteCountOutputType
  ...
  /**
   * CapaciteCountOutputType without action
   */
  export type CapaciteCountOutputTypeArgs = {
    /**
     * Select specific fields to fetch from the CapaciteCountOutputType
     */
    select?: CapaciteCountOutputTypeSelect | null
  }
  ...
  export type CarteSelect = {
    ...
    power?: boolean
    capaciteId?: boolean
    passiveCondition?: boolean
    type?: boolean | TypeArgs
    classe?: boolean | ClasseArgs
    capacite_passive?: boolean | CapaciteArgs
    capacite_actives?: boolean | Carte$capacite_activesArgs
  ...
  export type CarteGetPayload<S extends boolean | null | undefined | CarteArgs> =
    ...
    [P in TruthyKeys<S['include']>]:
        ...
        P extends 'capacite_passive' ? CapaciteGetPayload<S['include'][P]> | null :
        P extends 'capacite_actives' ? Array < CartesCapacictesActiveGetPayload<S['include'][P]>>  :
    ...
    [P in TruthyKeys<S['select']>]:
        ...
        P extends 'capacite_passive' ? CapaciteGetPayload<S['select'][P]> | null :
        P extends 'capacite_actives' ? Array < CartesCapacictesActiveGetPayload<S['select'][P]>>  :
  ...
  export class Prisma__CarteClient<T, Null = never> implements Prisma.PrismaPromise<T> {
    ...
    capacite_passive<T extends CapaciteArgs= {}>(args?: Subset<T, CapaciteArgs>): Prisma__CapaciteClient<CapaciteGetPayload<T> | Null>;

    capacite_actives<T extends Carte$capacite_activesArgs= {}>(args?: Subset<T, Carte$capacite_activesArgs>): Prisma.PrismaPromise<Array<CartesCapacictesActiveGetPayload<T>>| Null>;
  ...
  /**
   * Carte.capacite_actives
   */
  export type Carte$capacite_activesArgs = {
    /**
  ...
  export type CompetenceSelect = {
    ...
    name?: boolean
    description?: boolean
    Capacite?: boolean | Competence$CapaciteArgs
  ...
  export class Prisma__CompetenceClient<T, Null = never> implements Prisma.PrismaPromise<T> {
    ...
    Capacite<T extends Competence$CapaciteArgs= {}>(args?: Subset<T, Competence$CapaciteArgs>): Prisma.PrismaPromise<Array<CapaciteGetPayload<T>>| Null>;
   ...
   * Competence.Capacite
   */
  export type Competence$CapaciteArgs = {
    /**
  ...
  export type CapaciteSelect = {
    ...
    carte_passive?: boolean | Capacite$carte_passiveArgs
    carte_actives?: boolean | Capacite$carte_activesArgs
    _count?: boolean | CapaciteCountOutputTypeArgs
  }
  ...
  export type CapaciteGetPayload<S extends boolean | null | undefined | CapaciteArgs> =
    ...
    ? Capacite  & {
    [P in TruthyKeys<S['include']>]:
        P extends 'competence' ? CompetenceGetPayload<S['include'][P]> | null :
        P extends 'carte_passive' ? Array < CarteGetPayload<S['include'][P]>>  :
        P extends 'carte_actives' ? Array < CartesCapacictesActiveGetPayload<S['include'][P]>>  :
        P extends '_count' ? CapaciteCountOutputTypeGetPayload<S['include'][P]> :  never
  } 
    : S extends { select: any } & (CapaciteArgs | CapaciteFindManyArgs)
      ? {
    [P in TruthyKeys<S['select']>]:
        P extends 'competence' ? CompetenceGetPayload<S['select'][P]> | null :
        P extends 'carte_passive' ? Array < CarteGetPayload<S['select'][P]>>  :
        P extends 'carte_actives' ? Array < CartesCapacictesActiveGetPayload<S['select'][P]>>  :
        P extends '_count' ? CapaciteCountOutputTypeGetPayload<S['select'][P]> :  P extends keyof Capacite ? Capacite[P] : never
  } 
      : Capacite
  ...
  export class Prisma__CapaciteClient<T, Null = never> implements Prisma.PrismaPromise<T> {
    ...
    carte_passive<T extends Capacite$carte_passiveArgs= {}>(args?: Subset<T, Capacite$carte_passiveArgs>): Prisma.PrismaPromise<Array<CarteGetPayload<T>>| Null>;

    carte_actives<T extends Capacite$carte_activesArgs= {}>(args?: Subset<T, Capacite$carte_activesArgs>): Prisma.PrismaPromise<Array<CartesCapacictesActiveGetPayload<T>>| Null>;
  ...
  /**
   * Capacite.carte_passive
   */
  export type Capacite$carte_passiveArgs = {
    /**
     * Select specific fields to fetch from the Carte
     */
    select?: CarteSelect | null
  ...
  /**
   * Capacite.carte_actives
   */
  export type Capacite$carte_activesArgs = {
    /**
     * Select specific fields to fetch from the CartesCapacictesActive
     */
    select?: CartesCapacictesActiveSelect | null
  ...
  export type CartesCapacictesActiveGetPayload<S extends boolean | null | undefined | CartesCapacictesActiveArgs> =
    ...
    [P in TruthyKeys<S['include']>]:
        P extends 'capacite' ? CapaciteGetPayload<S['include'][P]> :
    ...
    : S extends { select: any } & (CartesCapacictesActiveArgs | CartesCapacictesActiveFindManyArgs)
      ? {
    [P in TruthyKeys<S['select']>]:
        P extends 'capacite' ? CapaciteGetPayload<S['select'][P]> :
  ...
  export interface CartesCapacictesActiveDelegate<GlobalRejectSettings extends Prisma.RejectOnNotFound | Prisma.RejectPerOperation | false | undefined> {
    ...
    **/
     ...
     * 
     * // Only select the `capaciteId`
     * const cartesCapacictesActiveWithCapaciteIdOnly = await prisma.cartesCapacictesActive.findMany({ select: { capaciteId: true } })
     * 
    **/
  ...
  export class Prisma__CartesCapacictesActiveClient<T, Null = never> implements Prisma.PrismaPromise<T> {
    ...
    capacite<T extends CapaciteArgs= {}>(args?: Subset<T, CapaciteArgs>): Prisma__CapaciteClient<CapaciteGetPayload<T> | Null>;
  ...
  export type CarteWhereInput = {
    ...
    capaciteId?: IntFilter | number
    passiveCondition?: StringFilter | string
    type?: XOR<TypeRelationFilter, TypeWhereInput> | null
    classe?: XOR<ClasseRelationFilter, ClasseWhereInput> | null
    capacite_passive?: XOR<CapaciteRelationFilter, CapaciteWhereInput> | null
    capacite_actives?: CartesCapacictesActiveListRelationFilter
  }
  ...
  export type CarteOrderByWithRelationInput = {
    ...
    classeId?: SortOrder
    power?: SortOrder
    capaciteId?: SortOrder
    passiveCondition?: SortOrder
    type?: TypeOrderByWithRelationInput
    classe?: ClasseOrderByWithRelationInput
    capacite_passive?: CapaciteOrderByWithRelationInput
    capacite_actives?: CartesCapacictesActiveOrderByRelationAggregateInput
  }
  ...
  export type CarteScalarWhereWithAggregatesInput = {
    ...
    capaciteId?: IntWithAggregatesFilter | number
    passiveCondition?: StringWithAggregatesFilter | string
  }
  ...
  export type CapaciteWhereInput = {
    ...
    name?: StringFilter | string
    description?: StringFilter | string
    competenceId?: IntNullableFilter | number | null
    competence?: XOR<CompetenceRelationFilter, CompetenceWhereInput> | null
    carte_passive?: CarteListRelationFilter
    carte_actives?: CartesCapacictesActiveListRelationFilter
  }
  ...
  export type CapaciteOrderByWithRelationInput = {
    ...
    carte_passive?: CarteOrderByRelationAggregateInput
    carte_actives?: CartesCapacictesActiveOrderByRelationAggregateInput
  }
  ...
  export type CapaciteScalarWhereWithAggregatesInput = {
    ...
    name?: StringWithAggregatesFilter | string
    description?: StringWithAggregatesFilter | string
    competenceId?: IntNullableWithAggregatesFilter | number | null
  }
  ...
  export type CartesCapacictesActiveWhereInput = {
    ...
    capacite?: XOR<CapaciteRelationFilter, CapaciteWhereInput>
  ...
  export type CartesCapacictesActiveOrderByWithRelationInput = {
    ...
    cost?: SortOrder
    color?: SortOrder
    capacite?: CapaciteOrderByWithRelationInput
    carte?: CarteOrderByWithRelationInput
  }

  export type CartesCapacictesActiveWhereUniqueInput = {
    capaciteId_carteId?: CartesCapacictesActiveCapaciteIdCarteIdCompoundUniqueInput
  }
  ...
  export type CarteCreateInput = {
    ...
    capacite_passive?: CapaciteCreateNestedOneWithoutCarte_passiveInput
    capacite_actives?: CartesCapacictesActiveCreateNestedManyWithoutCarteInput
  }
  ...
  export type CarteUncheckedCreateInput = {
    ...
    capaciteId: number
    passiveCondition: string
    capacite_actives?: CartesCapacictesActiveUncheckedCreateNestedManyWithoutCarteInput
  }
  ...
  export type CarteUpdateInput = {
    ...
    passiveCondition?: StringFieldUpdateOperationsInput | string
    type?: TypeUpdateOneWithoutCarteNestedInput
    classe?: ClasseUpdateOneWithoutCarteNestedInput
    capacite_passive?: CapaciteUpdateOneWithoutCarte_passiveNestedInput
    capacite_actives?: CartesCapacictesActiveUpdateManyWithoutCarteNestedInput
  }
  ...
  export type CarteUncheckedUpdateInput = {
    ...
    power?: IntFieldUpdateOperationsInput | number
    capaciteId?: IntFieldUpdateOperationsInput | number
    passiveCondition?: StringFieldUpdateOperationsInput | string
    capacite_actives?: CartesCapacictesActiveUncheckedUpdateManyWithoutCarteNestedInput
  }
  ...
  export type CompetenceCreateInput = {
    name: string
    description: string
    Capacite?: CapaciteCreateNestedManyWithoutCompetenceInput
  }
  ...
  export type CompetenceUncheckedCreateInput = {
    ...
    name: string
    description: string
    Capacite?: CapaciteUncheckedCreateNestedManyWithoutCompetenceInput
  }

  export type CompetenceUpdateInput = {
    name?: StringFieldUpdateOperationsInput | string
    description?: StringFieldUpdateOperationsInput | string
    Capacite?: CapaciteUpdateManyWithoutCompetenceNestedInput
  }
  ...
  export type CompetenceUncheckedUpdateInput = {
    ...
    name?: StringFieldUpdateOperationsInput | string
    description?: StringFieldUpdateOperationsInput | string
    Capacite?: CapaciteUncheckedUpdateManyWithoutCompetenceNestedInput
  }
  ...
  export type CapaciteCreateInput = {
    name: string
    description: string
    competence?: CompetenceCreateNestedOneWithoutCapaciteInput
    carte_passive?: CarteCreateNestedManyWithoutCapacite_passiveInput
    carte_actives?: CartesCapacictesActiveCreateNestedManyWithoutCapaciteInput
  }
  ...
  export type CapaciteUncheckedCreateInput = {
    ...
    description: string
    competenceId?: number | null
    carte_passive?: CarteUncheckedCreateNestedManyWithoutCapacite_passiveInput
    carte_actives?: CartesCapacictesActiveUncheckedCreateNestedManyWithoutCapaciteInput
  }

  export type CapaciteUpdateInput = {
    name?: StringFieldUpdateOperationsInput | string
    description?: StringFieldUpdateOperationsInput | string
    competence?: CompetenceUpdateOneWithoutCapaciteNestedInput
    carte_passive?: CarteUpdateManyWithoutCapacite_passiveNestedInput
    carte_actives?: CartesCapacictesActiveUpdateManyWithoutCapaciteNestedInput
  }
  ...
  export type CapaciteUncheckedUpdateInput = {
    ...
    name?: StringFieldUpdateOperationsInput | string
    description?: StringFieldUpdateOperationsInput | string
    competenceId?: NullableIntFieldUpdateOperationsInput | number | null
    carte_passive?: CarteUncheckedUpdateManyWithoutCapacite_passiveNestedInput
    carte_actives?: CartesCapacictesActiveUncheckedUpdateManyWithoutCapaciteNestedInput
  }
  ...
  export type CartesCapacictesActiveCreateInput = {
    cost: number
    color: string
    capacite: CapaciteCreateNestedOneWithoutCarte_activesInput
    carte: CarteCreateNestedOneWithoutCapacite_activesInput
  }
  ...
  export type CartesCapacictesActiveUpdateInput = {
    ...
    capacite?: CapaciteUpdateOneRequiredWithoutCarte_activesNestedInput
    carte?: CarteUpdateOneRequiredWithoutCapacite_activesNestedInput
  }
  ...
  export type CapaciteRelationFilter = {
    is?: CapaciteWhereInput | null
    isNot?: CapaciteWhereInput | null
  }
  ...
  export type CartesCapacictesActiveCapaciteIdCarteIdCompoundUniqueInput = {
    capaciteId: number
    carteId: number
  }
  ...
  export type CapaciteCreateNestedOneWithoutCarte_passiveInput = {
    create?: XOR<CapaciteCreateWithoutCarte_passiveInput, CapaciteUncheckedCreateWithoutCarte_passiveInput>
    connectOrCreate?: CapaciteCreateOrConnectWithoutCarte_passiveInput
    connect?: CapaciteWhereUniqueInput
  }
  ...
  export type CapaciteUpdateOneWithoutCarte_passiveNestedInput = {
    create?: XOR<CapaciteCreateWithoutCarte_passiveInput, CapaciteUncheckedCreateWithoutCarte_passiveInput>
    connectOrCreate?: CapaciteCreateOrConnectWithoutCarte_passiveInput
    upsert?: CapaciteUpsertWithoutCarte_passiveInput
    disconnect?: boolean
    delete?: boolean
    connect?: CapaciteWhereUniqueInput
    update?: XOR<CapaciteUpdateWithoutCarte_passiveInput, CapaciteUncheckedUpdateWithoutCarte_passiveInput>
  }
  ...
  export type CapaciteCreateNestedManyWithoutCompetenceInput = {
    create?: XOR<Enumerable<CapaciteCreateWithoutCompetenceInput>, Enumerable<CapaciteUncheckedCreateWithoutCompetenceInput>>
    connectOrCreate?: Enumerable<CapaciteCreateOrConnectWithoutCompetenceInput>
    createMany?: CapaciteCreateManyCompetenceInputEnvelope
    connect?: Enumerable<CapaciteWhereUniqueInput>
  }

  export type CapaciteUncheckedCreateNestedManyWithoutCompetenceInput = {
    create?: XOR<Enumerable<CapaciteCreateWithoutCompetenceInput>, Enumerable<CapaciteUncheckedCreateWithoutCompetenceInput>>
    connectOrCreate?: Enumerable<CapaciteCreateOrConnectWithoutCompetenceInput>
    createMany?: CapaciteCreateManyCompetenceInputEnvelope
    connect?: Enumerable<CapaciteWhereUniqueInput>
  ...
  export type CapaciteUpdateManyWithoutCompetenceNestedInput = {
    create?: XOR<Enumerable<CapaciteCreateWithoutCompetenceInput>, Enumerable<CapaciteUncheckedCreateWithoutCompetenceInput>>
    connectOrCreate?: Enumerable<CapaciteCreateOrConnectWithoutCompetenceInput>
    upsert?: Enumerable<CapaciteUpsertWithWhereUniqueWithoutCompetenceInput>
    createMany?: CapaciteCreateManyCompetenceInputEnvelope
    ...
    connect?: Enumerable<CapaciteWhereUniqueInput>
    update?: Enumerable<CapaciteUpdateWithWhereUniqueWithoutCompetenceInput>
    updateMany?: Enumerable<CapaciteUpdateManyWithWhereWithoutCompetenceInput>
    deleteMany?: Enumerable<CapaciteScalarWhereInput>
  }

  export type CapaciteUncheckedUpdateManyWithoutCompetenceNestedInput = {
    create?: XOR<Enumerable<CapaciteCreateWithoutCompetenceInput>, Enumerable<CapaciteUncheckedCreateWithoutCompetenceInput>>
    connectOrCreate?: Enumerable<CapaciteCreateOrConnectWithoutCompetenceInput>
    upsert?: Enumerable<CapaciteUpsertWithWhereUniqueWithoutCompetenceInput>
    createMany?: CapaciteCreateManyCompetenceInputEnvelope
  ...
  export type CompetenceCreateNestedOneWithoutCapaciteInput = {
    create?: XOR<CompetenceCreateWithoutCapaciteInput, CompetenceUncheckedCreateWithoutCapaciteInput>
    connectOrCreate?: CompetenceCreateOrConnectWithoutCapaciteInput
    connect?: CompetenceWhereUniqueInput
  }

  export type CarteCreateNestedManyWithoutCapacite_passiveInput = {
    create?: XOR<Enumerable<CarteCreateWithoutCapacite_passiveInput>, Enumerable<CarteUncheckedCreateWithoutCapacite_passiveInput>>
    connectOrCreate?: Enumerable<CarteCreateOrConnectWithoutCapacite_passiveInput>
    createMany?: CarteCreateManyCapacite_passiveInputEnvelope
    connect?: Enumerable<CarteWhereUniqueInput>
  }

  export type CartesCapacictesActiveCreateNestedManyWithoutCapaciteInput = {
    create?: XOR<Enumerable<CartesCapacictesActiveCreateWithoutCapaciteInput>, Enumerable<CartesCapacictesActiveUncheckedCreateWithoutCapaciteInput>>
    connectOrCreate?: Enumerable<CartesCapacictesActiveCreateOrConnectWithoutCapaciteInput>
    createMany?: CartesCapacictesActiveCreateManyCapaciteInputEnvelope
    connect?: Enumerable<CartesCapacictesActiveWhereUniqueInput>
  }

  export type CarteUncheckedCreateNestedManyWithoutCapacite_passiveInput = {
    create?: XOR<Enumerable<CarteCreateWithoutCapacite_passiveInput>, Enumerable<CarteUncheckedCreateWithoutCapacite_passiveInput>>
    connectOrCreate?: Enumerable<CarteCreateOrConnectWithoutCapacite_passiveInput>
    createMany?: CarteCreateManyCapacite_passiveInputEnvelope
    connect?: Enumerable<CarteWhereUniqueInput>
  ...
  export type CartesCapacictesActiveUncheckedCreateNestedManyWithoutCapaciteInput = {
    create?: XOR<Enumerable<CartesCapacictesActiveCreateWithoutCapaciteInput>, Enumerable<CartesCapacictesActiveUncheckedCreateWithoutCapaciteInput>>
    connectOrCreate?: Enumerable<CartesCapacictesActiveCreateOrConnectWithoutCapaciteInput>
    createMany?: CartesCapacictesActiveCreateManyCapaciteInputEnvelope
    connect?: Enumerable<CartesCapacictesActiveWhereUniqueInput>
  ...
  export type CompetenceUpdateOneWithoutCapaciteNestedInput = {
    create?: XOR<CompetenceCreateWithoutCapaciteInput, CompetenceUncheckedCreateWithoutCapaciteInput>
    connectOrCreate?: CompetenceCreateOrConnectWithoutCapaciteInput
    upsert?: CompetenceUpsertWithoutCapaciteInput
    disconnect?: boolean
    delete?: boolean
    connect?: CompetenceWhereUniqueInput
    update?: XOR<CompetenceUpdateWithoutCapaciteInput, CompetenceUncheckedUpdateWithoutCapaciteInput>
  }

  export type CarteUpdateManyWithoutCapacite_passiveNestedInput = {
    create?: XOR<Enumerable<CarteCreateWithoutCapacite_passiveInput>, Enumerable<CarteUncheckedCreateWithoutCapacite_passiveInput>>
    connectOrCreate?: Enumerable<CarteCreateOrConnectWithoutCapacite_passiveInput>
    upsert?: Enumerable<CarteUpsertWithWhereUniqueWithoutCapacite_passiveInput>
    createMany?: CarteCreateManyCapacite_passiveInputEnvelope
    set?: Enumerable<CarteWhereUniqueInput>
    disconnect?: Enumerable<CarteWhereUniqueInput>
    delete?: Enumerable<CarteWhereUniqueInput>
    connect?: Enumerable<CarteWhereUniqueInput>
    update?: Enumerable<CarteUpdateWithWhereUniqueWithoutCapacite_passiveInput>
    updateMany?: Enumerable<CarteUpdateManyWithWhereWithoutCapacite_passiveInput>
    deleteMany?: Enumerable<CarteScalarWhereInput>
  }

  export type CartesCapacictesActiveUpdateManyWithoutCapaciteNestedInput = {
    create?: XOR<Enumerable<CartesCapacictesActiveCreateWithoutCapaciteInput>, Enumerable<CartesCapacictesActiveUncheckedCreateWithoutCapaciteInput>>
    connectOrCreate?: Enumerable<CartesCapacictesActiveCreateOrConnectWithoutCapaciteInput>
    upsert?: Enumerable<CartesCapacictesActiveUpsertWithWhereUniqueWithoutCapaciteInput>
    createMany?: CartesCapacictesActiveCreateManyCapaciteInputEnvelope
    set?: Enumerable<CartesCapacictesActiveWhereUniqueInput>
    disconnect?: Enumerable<CartesCapacictesActiveWhereUniqueInput>
    delete?: Enumerable<CartesCapacictesActiveWhereUniqueInput>
    connect?: Enumerable<CartesCapacictesActiveWhereUniqueInput>
    update?: Enumerable<CartesCapacictesActiveUpdateWithWhereUniqueWithoutCapaciteInput>
    updateMany?: Enumerable<CartesCapacictesActiveUpdateManyWithWhereWithoutCapaciteInput>
    deleteMany?: Enumerable<CartesCapacictesActiveScalarWhereInput>
  }

  export type CarteUncheckedUpdateManyWithoutCapacite_passiveNestedInput = {
    create?: XOR<Enumerable<CarteCreateWithoutCapacite_passiveInput>, Enumerable<CarteUncheckedCreateWithoutCapacite_passiveInput>>
    connectOrCreate?: Enumerable<CarteCreateOrConnectWithoutCapacite_passiveInput>
    upsert?: Enumerable<CarteUpsertWithWhereUniqueWithoutCapacite_passiveInput>
    createMany?: CarteCreateManyCapacite_passiveInputEnvelope
  ...
  export type CartesCapacictesActiveUncheckedUpdateManyWithoutCapaciteNestedInput = {
    create?: XOR<Enumerable<CartesCapacictesActiveCreateWithoutCapaciteInput>, Enumerable<CartesCapacictesActiveUncheckedCreateWithoutCapaciteInput>>
    connectOrCreate?: Enumerable<CartesCapacictesActiveCreateOrConnectWithoutCapaciteInput>
    upsert?: Enumerable<CartesCapacictesActiveUpsertWithWhereUniqueWithoutCapaciteInput>
    createMany?: CartesCapacictesActiveCreateManyCapaciteInputEnvelope
  ...
  export type CapaciteCreateNestedOneWithoutCarte_activesInput = {
    create?: XOR<CapaciteCreateWithoutCarte_activesInput, CapaciteUncheckedCreateWithoutCarte_activesInput>
    connectOrCreate?: CapaciteCreateOrConnectWithoutCarte_activesInput
    connect?: CapaciteWhereUniqueInput
  }

  export type CarteCreateNestedOneWithoutCapacite_activesInput = {
    create?: XOR<CarteCreateWithoutCapacite_activesInput, CarteUncheckedCreateWithoutCapacite_activesInput>
    connectOrCreate?: CarteCreateOrConnectWithoutCapacite_activesInput
    connect?: CarteWhereUniqueInput
  }

  export type CapaciteUpdateOneRequiredWithoutCarte_activesNestedInput = {
    create?: XOR<CapaciteCreateWithoutCarte_activesInput, CapaciteUncheckedCreateWithoutCarte_activesInput>
    connectOrCreate?: CapaciteCreateOrConnectWithoutCarte_activesInput
    upsert?: CapaciteUpsertWithoutCarte_activesInput
    connect?: CapaciteWhereUniqueInput
    update?: XOR<CapaciteUpdateWithoutCarte_activesInput, CapaciteUncheckedUpdateWithoutCarte_activesInput>
  }

  export type CarteUpdateOneRequiredWithoutCapacite_activesNestedInput = {
    create?: XOR<CarteCreateWithoutCapacite_activesInput, CarteUncheckedCreateWithoutCapacite_activesInput>
    connectOrCreate?: CarteCreateOrConnectWithoutCapacite_activesInput
    upsert?: CarteUpsertWithoutCapacite_activesInput
    connect?: CarteWhereUniqueInput
    update?: XOR<CarteUpdateWithoutCapacite_activesInput, CarteUncheckedUpdateWithoutCapacite_activesInput>
  }
  ...
  export type CapaciteCreateWithoutCarte_passiveInput = {
    name: string
    description: string
    competence?: CompetenceCreateNestedOneWithoutCapaciteInput
    carte_actives?: CartesCapacictesActiveCreateNestedManyWithoutCapaciteInput
  ...
  export type CapaciteUncheckedCreateWithoutCarte_passiveInput = {
    id?: number
    name: string
    description: string
    competenceId?: number | null
  ...
  export type CapaciteCreateOrConnectWithoutCarte_passiveInput = {
    where: CapaciteWhereUniqueInput
    create: XOR<CapaciteCreateWithoutCarte_passiveInput, CapaciteUncheckedCreateWithoutCarte_passiveInput>
  }
  ...
  export type CapaciteUpsertWithoutCarte_passiveInput = {
    update: XOR<CapaciteUpdateWithoutCarte_passiveInput, CapaciteUncheckedUpdateWithoutCarte_passiveInput>
    create: XOR<CapaciteCreateWithoutCarte_passiveInput, CapaciteUncheckedCreateWithoutCarte_passiveInput>
  }

  export type CapaciteUpdateWithoutCarte_passiveInput = {
    name?: StringFieldUpdateOperationsInput | string
    description?: StringFieldUpdateOperationsInput | string
    competence?: CompetenceUpdateOneWithoutCapaciteNestedInput
    carte_actives?: CartesCapacictesActiveUpdateManyWithoutCapaciteNestedInput
  ...
  export type CapaciteUncheckedUpdateWithoutCarte_passiveInput = {
    id?: IntFieldUpdateOperationsInput | number
    name?: StringFieldUpdateOperationsInput | string
    description?: StringFieldUpdateOperationsInput | string
    competenceId?: NullableIntFieldUpdateOperationsInput | number | null
  ...
  export type CartesCapacictesActiveUpdateManyWithWhereWithoutCarteInput = {
    ...
    data: XOR<CartesCapacictesActiveUpdateManyMutationInput, CartesCapacictesActiveUncheckedUpdateManyWithoutCapacite_activesInput>
  }
  ...
  export type CapaciteCreateWithoutCompetenceInput = {
    name: string
    description: string
    carte_passive?: CarteCreateNestedManyWithoutCapacite_passiveInput
    carte_actives?: CartesCapacictesActiveCreateNestedManyWithoutCapaciteInput
  ...
  export type CapaciteUncheckedCreateWithoutCompetenceInput = {
    id?: number
    name: string
    description: string
    carte_passive?: CarteUncheckedCreateNestedManyWithoutCapacite_passiveInput
  ...
  export type CapaciteCreateOrConnectWithoutCompetenceInput = {
    where: CapaciteWhereUniqueInput
    create: XOR<CapaciteCreateWithoutCompetenceInput, CapaciteUncheckedCreateWithoutCompetenceInput>
  }

  export type CapaciteCreateManyCompetenceInputEnvelope = {
    data: Enumerable<CapaciteCreateManyCompetenceInput>
    skipDuplicates?: boolean
  }

  export type CapaciteUpsertWithWhereUniqueWithoutCompetenceInput = {
    where: CapaciteWhereUniqueInput
    update: XOR<CapaciteUpdateWithoutCompetenceInput, CapaciteUncheckedUpdateWithoutCompetenceInput>
    create: XOR<CapaciteCreateWithoutCompetenceInput, CapaciteUncheckedCreateWithoutCompetenceInput>
  }

  export type CapaciteUpdateWithWhereUniqueWithoutCompetenceInput = {
    where: CapaciteWhereUniqueInput
    data: XOR<CapaciteUpdateWithoutCompetenceInput, CapaciteUncheckedUpdateWithoutCompetenceInput>
  }

  export type CapaciteUpdateManyWithWhereWithoutCompetenceInput = {
  ...
  export type CompetenceCreateWithoutCapaciteInput = {
    name: string
    description: string
  }

  export type CompetenceUncheckedCreateWithoutCapaciteInput = {
    id?: number
    name: string
    description: string
  }

  export type CompetenceCreateOrConnectWithoutCapaciteInput = {
    where: CompetenceWhereUniqueInput
    create: XOR<CompetenceCreateWithoutCapaciteInput, CompetenceUncheckedCreateWithoutCapaciteInput>
  }

  export type CarteCreateWithoutCapacite_passiveInput = {
    name: string
    illustration: string
    power: number
    passiveCondition: string
  ...
  export type CarteUncheckedCreateWithoutCapacite_passiveInput = {
    id?: number
    name: string
    illustration: string
    typeId?: number | null
  ...
  export type CarteCreateOrConnectWithoutCapacite_passiveInput = {
    where: CarteWhereUniqueInput
    create: XOR<CarteCreateWithoutCapacite_passiveInput, CarteUncheckedCreateWithoutCapacite_passiveInput>
  }

  export type CarteCreateManyCapacite_passiveInputEnvelope = {
    data: Enumerable<CarteCreateManyCapacite_passiveInput>
    skipDuplicates?: boolean
  }

  export type CartesCapacictesActiveCreateWithoutCapaciteInput = {
    cost: number
    color: string
    carte: CarteCreateNestedOneWithoutCapacite_activesInput
  }

  export type CartesCapacictesActiveUncheckedCreateWithoutCapaciteInput = {
    carteId: number
    cost: number
    color: string
  }

  export type CartesCapacictesActiveCreateOrConnectWithoutCapaciteInput = {
    where: CartesCapacictesActiveWhereUniqueInput
    create: XOR<CartesCapacictesActiveCreateWithoutCapaciteInput, CartesCapacictesActiveUncheckedCreateWithoutCapaciteInput>
  }

  export type CartesCapacictesActiveCreateManyCapaciteInputEnvelope = {
    data: Enumerable<CartesCapacictesActiveCreateManyCapaciteInput>
    skipDuplicates?: boolean
  }

  export type CompetenceUpsertWithoutCapaciteInput = {
    update: XOR<CompetenceUpdateWithoutCapaciteInput, CompetenceUncheckedUpdateWithoutCapaciteInput>
    create: XOR<CompetenceCreateWithoutCapaciteInput, CompetenceUncheckedCreateWithoutCapaciteInput>
  }

  export type CompetenceUpdateWithoutCapaciteInput = {
    name?: StringFieldUpdateOperationsInput | string
    description?: StringFieldUpdateOperationsInput | string
  }

  export type CompetenceUncheckedUpdateWithoutCapaciteInput = {
    id?: IntFieldUpdateOperationsInput | number
    name?: StringFieldUpdateOperationsInput | string
    description?: StringFieldUpdateOperationsInput | string
  }

  export type CarteUpsertWithWhereUniqueWithoutCapacite_passiveInput = {
    where: CarteWhereUniqueInput
    update: XOR<CarteUpdateWithoutCapacite_passiveInput, CarteUncheckedUpdateWithoutCapacite_passiveInput>
    create: XOR<CarteCreateWithoutCapacite_passiveInput, CarteUncheckedCreateWithoutCapacite_passiveInput>
  }

  export type CarteUpdateWithWhereUniqueWithoutCapacite_passiveInput = {
    where: CarteWhereUniqueInput
    data: XOR<CarteUpdateWithoutCapacite_passiveInput, CarteUncheckedUpdateWithoutCapacite_passiveInput>
  }

  export type CarteUpdateManyWithWhereWithoutCapacite_passiveInput = {
    where: CarteScalarWhereInput
    data: XOR<CarteUpdateManyMutationInput, CarteUncheckedUpdateManyWithoutCarte_passiveInput>
  }

  export type CartesCapacictesActiveUpsertWithWhereUniqueWithoutCapaciteInput = {
    where: CartesCapacictesActiveWhereUniqueInput
    update: XOR<CartesCapacictesActiveUpdateWithoutCapaciteInput, CartesCapacictesActiveUncheckedUpdateWithoutCapaciteInput>
    create: XOR<CartesCapacictesActiveCreateWithoutCapaciteInput, CartesCapacictesActiveUncheckedCreateWithoutCapaciteInput>
  }

  export type CartesCapacictesActiveUpdateWithWhereUniqueWithoutCapaciteInput = {
    where: CartesCapacictesActiveWhereUniqueInput
    data: XOR<CartesCapacictesActiveUpdateWithoutCapaciteInput, CartesCapacictesActiveUncheckedUpdateWithoutCapaciteInput>
  }

  export type CartesCapacictesActiveUpdateManyWithWhereWithoutCapaciteInput = {
    where: CartesCapacictesActiveScalarWhereInput
    data: XOR<CartesCapacictesActiveUpdateManyMutationInput, CartesCapacictesActiveUncheckedUpdateManyWithoutCarte_activesInput>
  }

  export type CapaciteCreateWithoutCarte_activesInput = {
    name: string
    description: string
    competence?: CompetenceCreateNestedOneWithoutCapaciteInput
    carte_passive?: CarteCreateNestedManyWithoutCapacite_passiveInput
  ...
  export type CapaciteUncheckedCreateWithoutCarte_activesInput = {
    id?: number
    name: string
    description: string
    competenceId?: number | null
  ...
  export type CapaciteCreateOrConnectWithoutCarte_activesInput = {
    where: CapaciteWhereUniqueInput
    create: XOR<CapaciteCreateWithoutCarte_activesInput, CapaciteUncheckedCreateWithoutCarte_activesInput>
  }

  export type CarteCreateWithoutCapacite_activesInput = {
    name: string
    illustration: string
    power: number
    passiveCondition: string
  ...
  export type CarteUncheckedCreateWithoutCapacite_activesInput = {
    id?: number
    name: string
    illustration: string
    typeId?: number | null
  ...
  export type CarteCreateOrConnectWithoutCapacite_activesInput = {
    where: CarteWhereUniqueInput
    create: XOR<CarteCreateWithoutCapacite_activesInput, CarteUncheckedCreateWithoutCapacite_activesInput>
  }

  export type CapaciteUpsertWithoutCarte_activesInput = {
    update: XOR<CapaciteUpdateWithoutCarte_activesInput, CapaciteUncheckedUpdateWithoutCarte_activesInput>
    create: XOR<CapaciteCreateWithoutCarte_activesInput, CapaciteUncheckedCreateWithoutCarte_activesInput>
  }

  export type CapaciteUpdateWithoutCarte_activesInput = {
    name?: StringFieldUpdateOperationsInput | string
    description?: StringFieldUpdateOperationsInput | string
    competence?: CompetenceUpdateOneWithoutCapaciteNestedInput
    carte_passive?: CarteUpdateManyWithoutCapacite_passiveNestedInput
  ...
  export type CapaciteUncheckedUpdateWithoutCarte_activesInput = {
    id?: IntFieldUpdateOperationsInput | number
    name?: StringFieldUpdateOperationsInput | string
    description?: StringFieldUpdateOperationsInput | string
    competenceId?: NullableIntFieldUpdateOperationsInput | number | null
  ...
  export type CarteUpsertWithoutCapacite_activesInput = {
    update: XOR<CarteUpdateWithoutCapacite_activesInput, CarteUncheckedUpdateWithoutCapacite_activesInput>
    create: XOR<CarteCreateWithoutCapacite_activesInput, CarteUncheckedCreateWithoutCapacite_activesInput>
  }

  export type CarteUpdateWithoutCapacite_activesInput = {
    name?: StringFieldUpdateOperationsInput | string
    illustration?: StringFieldUpdateOperationsInput | string
    power?: IntFieldUpdateOperationsInput | number
    passiveCondition?: StringFieldUpdateOperationsInput | string
  ...
  export type CarteUncheckedUpdateWithoutCapacite_activesInput = {
    id?: IntFieldUpdateOperationsInput | number
    name?: StringFieldUpdateOperationsInput | string
    illustration?: StringFieldUpdateOperationsInput | string
    typeId?: NullableIntFieldUpdateOperationsInput | number | null
  ...
  export type CartesCapacictesActiveUncheckedUpdateManyWithoutCapacite_activesInput = {
    capaciteId?: IntFieldUpdateOperationsInput | number
    cost?: IntFieldUpdateOperationsInput | number
    color?: StringFieldUpdateOperationsInput | string
  }
  ...
  export type CapaciteCreateManyCompetenceInput = {
    id?: number
    name: string
    description: string
  }

  export type CapaciteUpdateWithoutCompetenceInput = {
    name?: StringFieldUpdateOperationsInput | string
    description?: StringFieldUpdateOperationsInput | string
    carte_passive?: CarteUpdateManyWithoutCapacite_passiveNestedInput
    carte_actives?: CartesCapacictesActiveUpdateManyWithoutCapaciteNestedInput
  ...
  export type CapaciteUncheckedUpdateWithoutCompetenceInput = {
    id?: IntFieldUpdateOperationsInput | number
    name?: StringFieldUpdateOperationsInput | string
    description?: StringFieldUpdateOperationsInput | string
    carte_passive?: CarteUncheckedUpdateManyWithoutCapacite_passiveNestedInput
  ...
  export type CarteCreateManyCapacite_passiveInput = {
    id?: number
    name: string
    illustration: string
    typeId?: number | null
  ...
  export type CartesCapacictesActiveCreateManyCapaciteInput = {
    carteId: number
    cost: number
    color: string
  }

  export type CarteUpdateWithoutCapacite_passiveInput = {
    name?: StringFieldUpdateOperationsInput | string
    illustration?: StringFieldUpdateOperationsInput | string
    power?: IntFieldUpdateOperationsInput | number
    passiveCondition?: StringFieldUpdateOperationsInput | string
  ...
  export type CarteUncheckedUpdateWithoutCapacite_passiveInput = {
    id?: IntFieldUpdateOperationsInput | number
    name?: StringFieldUpdateOperationsInput | string
    illustration?: StringFieldUpdateOperationsInput | string
    typeId?: NullableIntFieldUpdateOperationsInput | number | null
  ...
  export type CarteUncheckedUpdateManyWithoutCarte_passiveInput = {
    id?: IntFieldUpdateOperationsInput | number
    name?: StringFieldUpdateOperationsInput | string
    illustration?: StringFieldUpdateOperationsInput | string
    typeId?: NullableIntFieldUpdateOperationsInput | number | null
  ...
  export type CartesCapacictesActiveUpdateWithoutCapaciteInput = {
    cost?: IntFieldUpdateOperationsInput | number
    color?: StringFieldUpdateOperationsInput | string
    carte?: CarteUpdateOneRequiredWithoutCapacite_activesNestedInput
  }

  export type CartesCapacictesActiveUncheckedUpdateWithoutCapaciteInput = {
    carteId?: IntFieldUpdateOperationsInput | number
    cost?: IntFieldUpdateOperationsInput | number
    color?: StringFieldUpdateOperationsInput | string
  }

  export type CartesCapacictesActiveUncheckedUpdateManyWithoutCarte_activesInput = {
    carteId?: IntFieldUpdateOperationsInput | number
    cost?: IntFieldUpdateOperationsInput | number
    color?: StringFieldUpdateOperationsInput | string
  }
